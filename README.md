...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dev-api.stackbit.com/pull/603618ff4c5f6a0016844a1b
...
To start editing your site, you can use the Sanity interface at https://panoramic-sparrow-618ff.sanity.studio/.
...
Generated at `2021-02-24T09:15:53.260Z` by Stackbit version `0.3.50`.